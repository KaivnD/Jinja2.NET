...
public class ChatTemplateTests
{
    ...
    [InlineData("llama")]
    [InlineData("whisper")]
    [InlineData("HuggingFaceH4/zephyr-7b-beta (add_generation_prompt=false)")] // str differs
    [InlineData("HuggingFaceH4/zephyr-7b-beta (add_generation_prompt=true)")] // str differs
    ...
    [InlineData("Deci/DeciLM-7B-instruct")] // str differs
    ...
    [InlineData("TheBloke/deepseek-coder-33B-instruct-AWQ")] // str differs
    [InlineData("ericzzz/falcon-rw-1b-chat")] // indexing issue
    [InlineData("abacusai/Smaug-34B-v0.1")]
    [InlineData("maywell/Synatra-Mixtral-8x7B")] // str differs
    [InlineData("deepseek-ai/deepseek-coder-33b-instruct")] // str differs
    ...
    [InlineData("Qwen/Qwen3-0.6B")] // str differs
